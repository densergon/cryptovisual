					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="mt-0.5 text-[11px] text-surface-400 leading-relaxed">
								...
								AES, <strong className="text-amber-400">SubBytes</strong>{" "}
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="mt-0.5 text-[11px] text-surface-400 leading-relaxed">
								...
								<strong className="text-cyan-400">ShiftRows</strong> and{" "}
								<strong className="text-cyan-400">MixColumns</strong> spread a
								single byte&apos;s influence across the entire 4x4 state matrix.
							</p>
						</div>
					</div>
				</div>
