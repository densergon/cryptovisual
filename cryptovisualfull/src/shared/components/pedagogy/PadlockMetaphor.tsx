		...
		>
			...
			<div className="flex items-start gap-4">
				...
				<div className="flex-1 text-xs text-surface-400 leading-relaxed">
					<p>
						Think of your{" "}
						<strong className="text-asymmetric-400">Public Key</strong> as an
						open padlock — you can hand it out to anyone. They snap it shut to
						encrypt a message, but only you have the{" "}
						<strong className="text-asymmetric-300">Private Key</strong> to open
						it.
					</p>
				</div>
			</div>
